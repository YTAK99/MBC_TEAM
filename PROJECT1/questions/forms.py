    ...
    class Meta:
        ...
        widgets = {
            "title": forms.TextInput(
                attrs={
                    "placeholder": "제목은 간결하게 입력해주세요",
                    "class": "input-field",
                    "style": (
                        "width: 100%; background-color: #F5F3EE; border: none; "
            ...
            "tags": forms.CheckboxSelectMultiple(),     #태그(tags) 창 꾸미기
            "is_anonymous": forms.CheckboxInput(        #익명으로 올리기 버튼(is_anonymous)
